...
**Walkthrough**
* [Flag 1](#flag-1)
* [Flag 2: Manual Approach](#flag-2-manual-approach)
* [Flag 2: Automated Approach](#flag-2-automated-approach)
...
There are two flags:
![description](./img/Pasted%20image%2020260718172405.png)
<a id="build-up"></a>
```http
Build-Up
```
...
![description](./img/Pasted%20image%2020260718172254.png)

As seen, I completed all of them, the last one being the Recruit challenge. This leads me to believe that the knowledge from these prior rooms will be instrumental to solving the Recruit challenge and obtaining the flags.
...
http://10.82.175.157/
```
![description](./img/Pasted%20image%2020260718173549.png)
...
![description](./img/Pasted%20image%2020260718182023.png)
...
```
![description](./img/Pasted%20image%2020260718175230.png)
...
![description](./img/Pasted%20image%2020260718175545.png)
...
```
![description](./img/Pasted%20image%2020260718180410.png)
...
```
![description](./img/Pasted%20image%2020260719215210.png)
...
```
![description](./img/Pasted%20image%2020260718214055.png)
- The standard credentials are now known:
	- Username: `hr.`
	- Password: `hrpassword123`.

![description](./img/Pasted%20image%2020260719215519.png)
![description](./img/Pasted%20image%2020260719215454.png)
<a id="flag-2-manual-approach"></a>
...
![description](./img/Pasted%20image%2020260719215929.png)
...
' ORDER BY 5 -- -
```
![description](./img/Pasted%20image%2020260719200815.png)
...
```
![description](./img/Pasted%20image%2020260719200921.png)
...
```
![description](./img/Pasted%20image%2020260719211717.png)
...
```
![description](./img/Pasted%20image%2020260719211954.png)
...
```
![description](./img/Pasted%20image%2020260719212247.png)
...
```
![description](./img/Pasted%20image%2020260719212441.png)
- The admin credentials have now been revealed:
	- Username: `admin`.
	- Password: `admin@001admin`.

![description](./img/Pasted%20image%2020260719222114.png)
![description](./img/Pasted%20image%2020260719222152.png)
<a id="flag-2-automated-approach"></a>
...
![description](./img/Pasted%20image%2020260718215836.png)
- Save it to a text file:

![description](./img/Pasted%20image%2020260718215901.png)
...
```
![description](./img/Pasted%20image%2020260718220336.png)
...
```
![description](./img/Pasted%20image%2020260718220544.png)
...
```
![description](./img/Pasted%20image%2020260718221536.png)
- The admin credentials have now been revealed:
	- Username: `admin`.
	- Password: `admin@001admin`.
...
To remediate, an audit of publicly accessible content should be conducted and sensitive information should be removed, so that information disclosure does not occur. Next, a more secure system to retrieve candidate CVs should be in place that does not allow local file retrieval, which may require an overhaul of this feature. Finally, prepared statements should be applied to the input form so that each input is not treated as SQL code, preventing SQL injection.
